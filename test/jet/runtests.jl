...
if @isdefined(JET_REPORT_FILTER)
    result = JET.report_package(LoweredDistributions;
        target_modules = (LoweredDistributions,))
    ...
    JET.test_package(LoweredDistributions; target_modules = (LoweredDistributions,))
end
