...
```@meta
EditURL = "https://github.com/EpiAware/LoweredDistributions.jl/blob/main/NEWS.md"
```
...
See [GitHub Releases](https://github.com/EpiAware/LoweredDistributions.jl/releases) for minor/patch
release information.
