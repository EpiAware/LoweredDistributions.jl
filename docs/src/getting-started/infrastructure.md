...
`LoweredDistributions` adopts shared configuration and test infrastructure from
...
Two pieces keep `LoweredDistributions` aligned with the kit.
...
update("path/to/LoweredDistributions.jl")
```
